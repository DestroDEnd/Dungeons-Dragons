...
5. If the narrative dictates the player finds an item, add it to 'inventoryAdd'. If an item breaks or is lost, add it to 'inventoryRemove'. CRITICAL: If you remove an item, you MUST explicitly narrate its permanent destruction or loss so the player understands it is gone forever.
